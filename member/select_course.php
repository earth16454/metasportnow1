...
<body>
        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="select_course.php" class="h5 nav-link px-3 text-warning">Select course</a></li>
    ...
    <div class="container">
        <h1 class="text-center py-3">Select your course</h1>

        <img src="../images/p1.jpg" class="rounded mx-auto d-block w-50" />

        <form action="" method="POST">
            <div class="mx-auto w-25 my-3 text-center">
                <select class="form-select border border-dark" name="course">
                    <option selected>Choose your Course</option>
                    <option value="yoga">YOGA</option>
                    <option value="boxing">BOXING</option>
                    <option value="football">FOOTBALL</option>
                    <option value="badminton">BADMINTON</option>
                    <option value="bassketball">BASSKETBALL</option>
                    <option value="taekwondo">TAEKWONDO</option>
                    <option value="volleyball">VOLLEYBALL</option>
                    <option value="tennis">TENNIS</option>
                    <option value="swimming">SWIMMING</option>
                </select>
                <button type="submit" class="btn btn-warning px-4 mt-4" name="submit_course">Submit</button>
            </div>
        </form>
