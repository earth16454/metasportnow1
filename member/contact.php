        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="contact.php" class="h5 nav-link px-3 text-warning">Contact</a></li>
        ...
        <div class="col-md">
            ...
            <form class="needs-validation" novalidate>
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <label for="address" class="form-label">Call</label>
                        <input type="tel" class="form-control" id="call" placeholder="0999999999" maxlength="10" required>
                        <div class="invalid-feedback">
        ...
        (
            function() {
                window['__CF$cv$params'] = {
                    r: '6d5482a48f6e4b76',
                    m: 'aU3ttPuuju1Md3UFfkQzrJtf9v1etS.xT3.YteJjJog-1643480802-0-ASj2Upy3HWkWy+ceYl2ZRHH3lZ4pyYgiC1ZrWoXRPzIMEzgK0uwCfmZ9yFcZqqAywnutKE2Ao97SYJrTSCiu0wcQIObDRkf4j/FoM2Xyx+yIRFoI9M+58O2Lv+eUdo/mN6fgeiOU7gOdx+OWEIoODrCCAxEe2X+WIMcR5uHXNImIF0GEMXf7yJ4aV3JaVQakiQ==',
                    s: [0x8f46900bcc, 0x515a29faba],
                }
            }
        )();
    </script>
