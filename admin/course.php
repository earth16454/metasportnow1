  ...
  <main>
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <a href="course.php" class="nav-link active bg-warning text-black">
    ...
    <div class="container mt-2">
      <h2 class="text-center my-3">Course</h2>
      <div class="col-8 mx-auto my-3">
        <ul class="list-group shadow">
          <li class="list-group-item">
            <div class="row">
              <div class="col-9">
                <p class="fs-3">YOGA</p>
                <p>Customers : 16</p>
                <p>Trainer : Thanaphong Songsisai</p>
                <p>Total revenue : $2475</p>
              </div>
          ...
          <li class="list-group-item">
            <div class="row">
              <div class="col-9">
                <p class="fs-3">BOXING</p>
                <p>Customers : 14</p>
                <p>Trainer : TrainerA</p>
                <p>Total revenue : $1905</p>
              </div>
              <div class="col-3 text-end">
                <a href="" class="btn btn-sm btn-warning">Edit</a>
                <a href="" class="btn btn-sm btn-outline-danger">Delete</a>
          ...
          <li class="list-group-item">
            <div class="row">
              <div class="col-9">
                <p class="fs-3">FOOTBALL</p>
                <p>Customers : 22</p>
                <p>Trainer : TrainerB</p>
                <p>Total revenue : $3800</p>
              </div>
              <div class="col-3 text-end">
                <a href="" class="btn btn-sm btn-warning">Edit</a>
                <a href="" class="btn btn-sm btn-outline-danger">Delete</a>
          ...
          <li class="list-group-item">
            <div class="row">
              <div class="col-9">
                <p class="fs-3">BADMINTON</p>
                <p>Customers : 8</p>
                <p>Trainer : TrainerC</p>
                <p>Total revenue : $475</p>
              </div>
              <div class="col-3 text-end">
                <a href="" class="btn btn-sm btn-warning">Edit</a>
                <a href="" class="btn btn-sm btn-outline-danger">Delete</a>
          ...
          <li class="list-group-item">
            <div class="row">
              <div class="col-9">
                <p class="fs-3">BASSKETBALL</p>
                <p>Customers : 16</p>
                <p>Trainer : TrainerD</p>
                <p>Total revenue : $5175</p>
              </div>
              <div class="col-3 text-end">
                <a href="" class="btn btn-sm btn-warning">Edit</a>
                <a href="" class="btn btn-sm btn-outline-danger">Delete</a>
          ...
          <li class="list-group-item">
            <div class="row">
              <div class="col-9">
                <p class="fs-3">TAEKWONDO</p>
                <p>Customers : 6</p>
                <p>Trainer : TrainerE</p>
                <p>Total revenue : $875</p>
              </div>
              <div class="col-3 text-end">
                <a href="" class="btn btn-sm btn-warning">Edit</a>
                <a href="" class="btn btn-sm btn-outline-danger">Delete</a>
          ...
          <li class="list-group-item">
            <div class="row">
              <div class="col-9">
                <p class="fs-3">VOLLEYBALL</p>
                <p>Customers : 12</p>
                <p>Trainer : TrainerF</p>
                <p>Total revenue : $1305</p>
              </div>
              <div class="col-3 text-end">
                <a href="" class="btn btn-sm btn-warning">Edit</a>
                <a href="" class="btn btn-sm btn-outline-danger">Delete</a>
          ...
          <li class="list-group-item">
            <div class="row">
              <div class="col-9">
                <p class="fs-3">TENNIS</p>
                <p>Customers : 6</p>
                <p>Trainer : TrainerG</p>
                <p>Total revenue : $998</p>
              </div>
              <div class="col-3 text-end">
                <a href="" class="btn btn-sm btn-warning">Edit</a>
                <a href="" class="btn btn-sm btn-outline-danger">Delete</a>
          ...
          <li class="list-group-item">
            <div class="row">
              <div class="col-9">
                <p class="fs-3">SWIMMING</p>
                <p>Customers : 18</p>
                <p>Trainer : TrainerH</p>
                <p>Total revenue : $5875</p>
              </div>
              <div class="col-3 text-end">
                <a href="" class="btn btn-sm btn-warning">Edit</a>
                <a href="" class="btn btn-sm btn-outline-danger">Delete</a>
