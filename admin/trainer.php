  ...
  <main>
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <a href="trainer.php" class="nav-link active bg-warning text-black">
    ...
    <div class="container mt-2 mx-5">
      <h2 class="text-center my-3">Trainer</h2>
        ...
        <div class="col-12 col-xl-12 mb-4 mb-lg-0">
          <div class="card">
            <div class="card-body md-4">
              <a href="add_trainer.php" class="btn btn-outline-success"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td><?php echo $row['trainer_firstname'] . " " . $row['trainer_lastname']; ?></td>
                        <td><?php echo $row['trainer_nickname']; ?></td>
                        <td><?php echo $row['trainer_birthday']; ?></td>
                        <td><?php echo $row['trainer_sex']; ?></td>
                        <td><?php echo $row['trainer_tel']; ?></td>
                        <td><?php echo $row['trainer_subject']; ?></td>
                        <td><?php echo $row['trainer_create_at']; ?></td>
                        <td><a href="../config/delete.php?del=<?php echo $row['trainer_id']; ?>" class="btn btn-sm btn-danger">Delete</a></td>
                      </tr>
